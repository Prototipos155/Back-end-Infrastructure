    ...
    return """
        ...
        begin
            etiqueta: begin
                ...
                /*
                1->Exito
                -1->ya eiste la categoria
                -2->no se pudo hacer el registro de la categ
                -3->ya existe el tema general
                -4->no se pudo hacer el registro del tema
                -5->ya existe el subtema general
                -6->no se pudo hacer el registro del subtema
                */
                if(@idCateg=-1) then
...
def codigo_insert_usuario():
    # perfiles y sus contraseñas:
    #     AdminM->Entr4R#125
    return """
    INSERT INTO perfil (id_rol, id_foto_perfil,  nombres, apellidos, nombre_usuario, telefono, correo, contraseña_encript, cuenta_activa) VALUES (1,1, 'Martha', 'Martina', 'AdminM', '4491261629', 'martnalej@gmail.com', 'iaoIaZB7SMfIeAw7mgpyH5dHoa/d/ZPmIu29W9epsbK3MB63r/zW4cxZGswS8AiM75GUl8a/M62ieQ==', 1)
    """
